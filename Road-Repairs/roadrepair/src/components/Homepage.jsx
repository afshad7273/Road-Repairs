    ...
    <div className="bg-gradient-to-r from-gray-900 to-blue-950 text-white min-h-screen w-full">
      ...
      <nav className="bg-gray-950 p-6 text-lg shadow-lg w-full">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <ul className="flex space-x-6 items-center">
            ...
            {/* <li><Link to="/admin" className="hover:text-yellow-400 transition">Admin Login</Link></li>
            <li><Link to="/workshop" className="hover:text-yellow-400 transition">Workshop Login</Link></li> */}
          </ul>
        </div>
      </nav>
      ...
      <footer className="py-10 bg-gray-950 text-yellow-400 w-full text-center">
        <ul className="flex flex-wrap justify-center space-x-6 text-lg">
          ...
          <li><Link to="/adminlogin" className="hover:text-white transition">Admin Login</Link></li>
          <li><Link to="/workshoplogin" className="hover:text-white transition">Workshop Login</Link></li>
        </ul>
