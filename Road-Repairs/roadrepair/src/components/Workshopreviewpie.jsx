...
// import { getRatingDistributionAPI } from "../services/reviewServices";
...
// const WorkshopRatingPie = () => {
//   const [ratingStats, setRatingStats] = useState([]);

//   const { data, isLoading, isError, error } = useQuery({
//     queryKey: ["rating-distribution"],
//     queryFn: getRatingDistributionAPI,
//   });

//   useEffect(() => {
//     if (data?.length > 0) {
//       // Group workshops by rating bands
//       const ratingBands = [
...
//         const band = ratingBands.find(
//           (b) => rating >= b.min && rating < b.max
//         ) || ratingBands[0]; // Default to 0-1 if rating is 0
//         band.count += 1;
//       });

//       // Filter out bands with zero counts and format for chart
//       const chartData = ratingBands
//         .filter((band) => band.count > 0)
//         .map((band) => ({
//           name: `${band.range} Stars`,
//           value: band.count,
//         }));
...
//               </li>
//             </Link>
//             <Link to="/workshopreviewpie">
//               <li className="p-4 hover:bg-gray-700 rounded cursor-pointer transition-colors duration-200">
//                 Review Analytics
//               </li>
//             </Link>
//             <Link to="/workshopratingpie">
//               <li className="p-4 hover:bg-gray-700 rounded cursor-pointer transition-colors duration-200">
//                 Rating Distribution
//               </li>
//             </Link>
...
//           <h2 className="text-4xl font-bold text-gray-800">Workshop Rating Distribution</h2>
...
// export default WorkshopRatingPie;
